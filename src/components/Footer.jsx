  ...
  return (
    <div className="bg-[#000] text-white min-h-[40vh]">
      <PageLayout>
          ...
          <div className="max-w-[350px]">
            <h4 className="flex items-center text-xl mb-4">
              <div className="text-2xl font-bold">
                Web Design<span className="text-[#F55F1D]"> AGENCY</span>
              </div>
            </h4>
            <p className="mb-2">
            Empowering Your Digital Presence. Creativity Meets Functionality. Web Design that Stands Out. Elevate Your Digital Identity. Transforming Your Online Journey.
        ...
        <footer>
          <p className="text-[14px] mt-5">Copyright Design Agency 2021 - 2024</p>
        </footer>
      </PageLayout>
    </div>
  );
